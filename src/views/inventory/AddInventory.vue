<template>
	<div>
		<inventory-form v-if="categories.length > 0" @added="watchCount" :categories="categories"></inventory-form>
		...
		<h1 class="main-b" v-if="categories.length > 0">Current Inventory</h1>
		<inventory-table v-if="categories.length > 0"></inventory-table>
	</div>
</template>
