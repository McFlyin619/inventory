	...
	<div class="container mt-5 text-end">
		...
		<form @submit.prevent="addInventory">
			<div v-for="(input, index) in inventory" :key="`inventoryInput-${index}`" class="row mb-2">
				<div class="card bg-dark-3 py-1 mb-3">
							...
							<div class="col-md-3">
								<div class="form-floating">
									<select
										...
										v-model.trim="input.inventoryCategory"
									>
										<option selected>Select a category</option>
										<option v-for="cat in categories" :key="cat" :value="cat.categoryName">
											{{ cat.categoryName }}
										</option>
									</select>
							...
							<div class="col-md-3 mb-2">
								<div class="form-floating">
									<input
										...
										id="inventoryName"
										class="form-control"
										v-model.trim="input.inventoryName"
									/>
